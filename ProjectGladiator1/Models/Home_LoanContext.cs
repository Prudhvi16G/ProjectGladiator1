...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=PRUDHVI;Database=Home_Loan;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AccountDetails>(entity =>
            {
                entity.HasKey(e => e.AccountNumber)
                    .HasName("PK__Account___BE2ACD6E52CDF21D");
            ...
            modelBuilder.Entity<AdminDetails>(entity =>
            {
                entity.HasKey(e => e.Username)
                    .HasName("PK__Admin_De__F3DBC5735C84F00A");
            ...
            modelBuilder.Entity<ApplicationDetails>(entity =>
            {
                entity.HasKey(e => e.LoanId)
                    .HasName("PK__Applicat__4F5AD437F845048B");
            ...
            {
                entity.HasKey(e => e.Username)
                    .HasName("PK__Income_D__F3DBC57328C390F5");
            ...
            modelBuilder.Entity<LoanDetails>(entity =>
            {
                entity.HasKey(e => e.ApplicationId)
                    .HasName("PK__Loan_Det__C93A4F79DC17663A");
            ...
            {
                entity.HasKey(e => e.Username)
                    .HasName("PK__Personal__F3DBC5731E334FCA");
